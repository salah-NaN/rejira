    ...
    return (
        <div className="select-none" ref={dropdownRef}>
            ...
            >
                ...
                <ul className={` absolute top-5 -right-2 w-38 ${isOpen ? 'visible' : 'hidden'} bg-[#ffffff] shadow-lg  text-gray-900`}>
                    <li className="px-14 py-2 w-full hover:bg-[rgb(207,207,207)] transition duration-200" >Settings</li>
                    <li className={` px-10 py-2 w-full hover:bg-[#cfcfcf] text-red-600 transition duration-200`}
                        onClick={handleLogout} to='/' >Sign out</li>
                </ul>
            </button>
